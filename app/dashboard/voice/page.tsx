...
export default async function VoiceAgentDashboard() {
    ...
    return (
        <div className="space-y-8 animate-fade-in">
            <header className="mb-8 flex justify-between items-end">
                <div>
                    <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-slate-400">Voice AI Agent</h1>
                    <p className="text-slate-400 mt-1">Monitor your AI receptionist's performance and logs.</p>
                </div>
                <div className="flex gap-3">
                    <Link href="/dashboard/settings" className="px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-medium rounded-lg transition-colors shadow-lg shadow-indigo-500/20">
                        Agent Settings
                    </Link>
                </div>
            </header>
